...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ReservationCreatedEvent> paymentFailedEventProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ReservationCreatedEvent> paymentFailedEventKafkaTemplate() {
