package com.rent_a_car.car_service.command.dto.rentalConditions;

public class CreateRentalConditionResponse {
    private int id;
    ...
    public CreateRentalConditionResponse() {
    }

    public CreateRentalConditionResponse(int id, int minimumAge, int minimumLicenseAge, int requiredCreditCards) {
        this.id = id;
